      ...
      <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              ...
              <a href="" class="btn btn-warning float-right" data-target="#add-modal" data-toggle="modal">Tambah Produk</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="berat" id="berat" value="{{ old('berat') }}"  class="form-control @error('berat')
                    is-invalid
                  @enderror">
                  <div class="invalid-feedback">
                    @error('berat')
  ...
  @foreach ($produk as $edit)
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('produk.update', $edit->id) }}" method="post" class="needs-validation" 
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Nama</label>
              <input type="text" name="name" id="name" value="{{ $edit->name }}"  class="form-control @error('name')
                is-invalid
              @enderror">
              <div class="invalid-feedback">
                @error('name')
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Stok /Sak</label>
                  <input type="number" name="stok" id="stok" value="{{ $edit->stok }}"  class="form-control @error('stok')
                    is-invalid
                  @enderror">
                  <div class="invalid-feedback">
                    @error('stok')
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Berat /Kg</label>
                  <input type="number" name="berat" id="berat" value="{{ $edit->berat }}"  class="form-control @error('berat')
                    is-invalid
                  @enderror">
                  <div class="invalid-feedback">
                    @error('berat')
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Harga</label>
                  <input type="text" name="harga" id="harga" value="{{ $edit->harga }}"  class="form-control @error('harga')
                    is-invalid
                  @enderror">
                  <div class="invalid-feedback">
                    @error('harga')
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="kategori_id" id="kategori_id" class="form-control @error('kategori_id')
                    is-invalid
                  @enderror">
                    <option value="1"  @if ($edit->kategori_id == "1")
                      selected
                    @endif>Baru</option>
                    <option value="2"  @if ($edit->kategori_id == "2")
                      selected
                    @endif>Terlaris</option>
                  </select>
                  <div class="invalid-feedback">
                    @error('kategori_id')
                      {{ $message }}
