                  ...
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal" action="{{ route('profile.update',Auth::user()->id) }}" method="POST">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputName2" name="phone" value="{{ Auth::user()->phone }}">
                        </div>
                      </div>
                      @if (Auth::user()->user_id == 'admin')
                      <div class="form-group row" hidden>
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" name="nama_toko" placeholder="Nama toko" value="{{ Auth::user()->nama_toko }}">
                        </div>
                      </div>
                      @elseif (Auth::user()->user_id == 'seller')
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" name="alamat" placeholder="Alamat">{{ Auth::user()->alamat }}</textarea>
                        </div>
                      </div>
